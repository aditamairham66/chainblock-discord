...
const gun = Gun("https://discord-clone-next.herokuapp.com/gun")
...
export const DiscordProvider = ({children}) => {
    ...
    const createUserAccount = async (userAddress = currentAccount) => {
        ...
        try {
            ...
            try {
                fetch(`${process.env.NEXT_PUBLIC_API_URL}/createuser`, {
                    method: 'POST',
                    headers: {
            ...
            try {
                fetch(`${process.env.NEXT_PUBLIC_API_URL}/createdm`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
    ...
    return (
        <DiscordContext.Provider value={{
            ...
            connectWallet,
            currentUser,
        }}>{children}</DiscordContext.Provider>
    )
}